...
const SRC_CASES: &[Cell] = &[
    ...
    Cell::pending(P::Exists, S::CommittedStaged, O::ConcurrencyError),
    Cell::pending(P::Exists, S::CommittedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Exists, S::CommittedStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Exists, S::NewStaged, O::ConcurrencyError),
    Cell::pending(P::Exists, S::IntentToAdd, O::ConcurrencyError),
    Cell::pending(P::Exists, S::NewStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Exists, S::Untracked, O::ConcurrencyError),
    // ExpectBlob(HEAD) — defined iff committed
    Cell::new(P::Head, S::CleanCommitted, O::Ok),
    Cell::pending(P::Head, S::CommittedStaged, O::ConcurrencyError),
    Cell::pending(P::Head, S::CommittedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Head, S::CommittedStagedUnstaged, O::ConcurrencyError),
    // ExpectBlob(INDEX) — defined iff staged
    Cell::pending(P::Index, S::CommittedStaged, O::Ok),
    Cell::pending(P::Index, S::CommittedStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Index, S::NewStaged, O::Ok),
    Cell::pending(P::Index, S::NewStagedUnstaged, O::ConcurrencyError),
    ...
    Cell::pending(P::Wrong, S::CommittedStaged, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::CommittedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::CommittedStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::NewStaged, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::IntentToAdd, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::NewStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Wrong, S::Untracked, O::ConcurrencyError).on(Backend::Git),
...
const DEST_CASES: &[Cell] = &[
    ...
    Cell::pending(P::Absent, S::CommittedStaged, O::ConcurrencyError),
    Cell::pending(P::Absent, S::CommittedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Absent, S::CommittedStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Absent, S::NewStaged, O::ConcurrencyError),
    Cell::pending(P::Absent, S::IntentToAdd, O::ConcurrencyError),
    Cell::pending(P::Absent, S::NewStagedUnstaged, O::ConcurrencyError),
    Cell::pending(P::Absent, S::Untracked, O::ConcurrencyError).on(Backend::Git),
